  ...
  void _submit() async {
    ...
    try {
      if (_isLogin) {
        ...
        debugPrint("Logged in $userCredentials");
      } else {
...
## Showing different screens based on logging in state (Authentication state)

- Create a new file called `screens/chat.dart`
- Use `StreamBuilder widget` in the main.dart file
...
import 'package:chat_app/src/screens/chat.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:chat_app/src/screens/auth.dart';
