...
// title<String> : Title for the meal
// imageURl<String> : URL of the image
// ingredients<List<String>> : List of ingredients needed for the meal
// steps<List<String>> : Step-by-step instructions to prepare the meal
// duration<int> : Estimated cooking time in minutes
// complexity<Complexity> : Difficulty level of preparing the meal (simple, challenging, hard)
// affordability<Affordability> : Relative cost of ingredients (affordable, pricey, luxurious)
